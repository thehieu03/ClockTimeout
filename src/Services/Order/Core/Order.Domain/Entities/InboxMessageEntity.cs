...
public sealed class InboxMessageEntity:Entity<Guid>
{
    ...
    public static InboxMessageEntity Create(Guid id, string EventTypeFilter, string content, DateTimeOffset receivedOnUtc)
    {
