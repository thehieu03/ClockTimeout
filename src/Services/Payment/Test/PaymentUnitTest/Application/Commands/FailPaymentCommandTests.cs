...
public class FailPaymentCommandTests
{
    ...
    public async Task Handle_ShouldMarkPaymentAsFailed()
    {
        ...
        var command = new FailPaymentCommand(paymentId, errorMessage);
    ...
    public async Task Handle_WhenPaymentNotFound_ShouldThrowNotFoundException()
    {
        ...
        var command = new FailPaymentCommand(paymentId, "Error");
...
public class FailPaymentCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new FailPaymentCommand(Guid.NewGuid(), "Payment failed");
    ...
    {
        // Arrange
        var command = new FailPaymentCommand(Guid.NewGuid(), "");
    ...
    public void Validate_WithTooLongErrorMessage_ShouldFail()
    {
        ...
        var command = new FailPaymentCommand(Guid.NewGuid(), longMessage);
